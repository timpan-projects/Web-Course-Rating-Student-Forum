...
<html>
	...
	<body class="is-preload">
		...
		<section id="main" class="wrapper">
			<div class="inner">
			<a href="insert_comment.php" class="button primary">+新增心得</a>
			<br><br>
		<?php
			//連接資料庫	
			...
			include("mysql_connect.inc.php");
			$id = $_SESSION['username'];
			$sql = "SELECT * FROM course_comments WHERE username='$id' ORDER BY comment_number DESC";
			$result = mysqli_query($conn, $sql);
		...
		<!-- Main -->
				...
				<div class="content">
					...
					<!---->
					<a href="show_course.php?class_id=<?= $row["class_number"] ?>"><a style="float: right" href="delete_comment.php?comment_number=<?=$row["comment_number"]?>" class="button primary"><i class="far fa-trash-alt"></i>&nbsp;刪除</a>
						<?php

		...
		<section id="main" class="wrapper">
			<div class="inner">
				<?php
                        ...
                        include("mysql_connect.inc.php");
                        $sql = "SELECT * FROM course_information ORDER BY avg DESC Limit 5";
                        $result = mysqli_query($conn, $sql);
						
                        if (mysqli_num_rows($result) > 0) {
                            // output data of each row ?>
						<font size='4' color='red'>綜合分數最高TOP5</font>
                    ...
                    <?php   } else {
					    ...
					    $sql = "SELECT * FROM course_information ORDER BY avg_cool DESC Limit 5";
                        $result = mysqli_query($conn, $sql);
						
                        if (mysqli_num_rows($result) > 0) {
                            // output data of each row ?>
						<font size='4' color='red'>涼度最高TOP5</font>
						<div class="table-wrapper">
						<table>
							<thead>
								<tr>
                    ...
                    <?php   } else {
					    ...
					    $sql = "SELECT * FROM course_information ORDER BY avg_sweet DESC Limit 5";
                        $result = mysqli_query($conn, $sql);
						
                        if (mysqli_num_rows($result) > 0) {
                            // output data of each row ?>
						<font size='4' color='red'>甜度最高TOP5</font>
						<div class="table-wrapper">
						<table>
							<thead>
								<tr>
                    ...
                    <?php   } else {
					    ...
					    $sql = "SELECT * FROM course_information ORDER BY avg_difficulty DESC Limit 5";
                        $result = mysqli_query($conn, $sql);
						
                        if (mysqli_num_rows($result) > 0) {
                            // output data of each row ?>
						<font size='4' color='red'>難度最高TOP5</font>
						<div class="table-wrapper">
						<table>
							<thead>
								<tr>
